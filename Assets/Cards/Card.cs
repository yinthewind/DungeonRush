...
public class Card
{
	...
	{
		var damageOutput = (baseDamage + this.FightScene.Player.States.AttackModifier 
			+ this.FightScene.GameStats.GetAttack()) 
			* this.FightScene.Player.States.DamageModifier * this.damageMotifier;
